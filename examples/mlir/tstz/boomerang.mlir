module {
  func.func @smart_contract(%param: !michelson.unit, %storage: !michelson.unit) -> !michelson.pair<!michelson.list<!michelson.operation>, !michelson.unit> {
    ...
    %someContract = "michelson.get_contract"(%address): (!michelson.address) -> !michelson.option<!michelson.contract<!michelson.unit>>
    %contract = "michelson.assert_some"(%someContract): (!michelson.option<!michelson.contract<!michelson.unit>>) -> !michelson.contract<!michelson.unit>
